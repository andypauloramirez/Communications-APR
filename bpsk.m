...
N=10e3; % Number of bits , size of transmitted signal x_inp=[x_1 x_2 ... x_N] 
x_inp= randint([0,1],1,N);  % binary signal 0 or 1 % message to be transmitted                               
...
mc=4;  % fc>>fs fc=mc*fs fs=1/Tb        %factor de 
